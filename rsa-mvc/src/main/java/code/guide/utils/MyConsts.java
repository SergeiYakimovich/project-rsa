...
public class MyConsts {
    public static boolean IS_NAME_MAIN = true;
    ...
    public final static String GUIDE_FILE_NAME = "KIA-TOYOTA-VW";
...
//    public final static List<String> MODEL_NAMES = List.of("RIO", "POLO");
    public final static List<String> MODEL_NAMES = List.of("KIA", "TOYOTA", "VW");
