...
public class MyConsts {
    public final static boolean IS_NAME_MAIN = false;
    ...
    public final static String PAINT_DIR = BASE_URL + "paint/";
    ...
    public final static String GUIDE_PAINT_FILE = GUIDE_DIR + GUIDE_FILE_NAME + "-paint.txt";
